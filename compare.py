...
wd = webdriver.Chrome(r'E:\Projects\Summer Training Project sem5\chromedriver_win32\chromedriver.exe',options=CO)
print ("*************************************************************************** \n")
...
f_price = wd.find_element_by_xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[3]/div/div[4]/div[1]/div/div[1]")
pr_name = wd.find_element_by_xpath("/html/body/div[1]/div/div[3]/div[1]/div[2]/div[3]/div/div[1]/h1/span")
...
wd.get(source3)
wd.implicitly_wait(wait_imp)
c_price = wd.find_element_by_xpath("/html/body/div[1]/div/main/div[1]/div[2]/div/div/div/div/div[2]/div/ul/li[1]/div[2]/span[1]/span[2]")
raw_c = c_price.text
# print (raw_c[1:7])
...
print("  Price available at Amazon is: "+raw_p[2:10])
